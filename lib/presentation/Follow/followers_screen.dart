...
class FollowerViewPage extends StatefulWidget {
  const FollowerViewPage({Key? key}) : super(key: key);

  @override
  State<FollowerViewPage> createState() => _FollowerViewPageState();
}

class _FollowerViewPageState extends State<FollowerViewPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(child: Followers()),
    );
  }
